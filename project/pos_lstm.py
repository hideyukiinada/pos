...
def load_data(test_ratio=0.1):
    ...
    for tagged_sentence in tagged_sentences:
        ...
        tag_id_only_sentence = [tag2id[word] for word, tag in tagged_sentence]
    ...
    # batch_size = 64
    # num_training_samples =  int(num_samples*(1-test_ratio))//batch_size*batch_size
    # num_test_samples = (num_samples - num_training_samples)//batch_size*batch_size
    ...
    # Reverse dict
    id2word = {id: word for id, word in word2id.items()}
    id2tag = {id: word for id, word in tag2id.items()}
...
def main():
    ...
    # Set up a model
    model = Sequential()
    model.add(LSTM(500, input_shape=(MAX_SEQUENCE_SIZE, 1),
